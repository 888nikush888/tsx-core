...
def _shared_contracts():
    from ccxt_capabilities import CANDIDATE_PRO_REQUIREMENTS as CCXT_CANDIDATE_PRO_REQUIREMENTS, CANDIDATE_REST_REQUIREMENTS as CCXT_CANDIDATE_REST_REQUIREMENTS, PRO_CAPABILITIES as CCXT_PRO_CAPABILITIES, REST_CAPABILITIES as CCXT_REST_CAPABILITIES
    from ccxt_profiles import PROFILES as CCXT_PROFILES
    return CCXT_CANDIDATE_PRO_REQUIREMENTS, CCXT_CANDIDATE_REST_REQUIREMENTS, CCXT_PRO_CAPABILITIES, CCXT_REST_CAPABILITIES, CCXT_PROFILES
