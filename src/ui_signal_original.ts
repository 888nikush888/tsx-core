...
function originalColumn(kind: string, field: string, id: string) {
  ...
  const columns = Object.hasOwn(ORIGINAL_COLUMNS, kind) ? ORIGINAL_COLUMNS[kind] : undefined;
  if (!columns || !Object.hasOwn(columns, field)) throw new Error('Invalid original field or message ID.');
