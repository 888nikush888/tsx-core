...
export const RUNTIME_INTEGER_RANGES = {
  ...
  backupOffsiteTimeoutMs: [1_000, 900_000], backupOffsiteMaxRecoveryBytes: [1_048_576, 8_589_934_592],
  backupOffsiteRetentionDays: [0, 3_650], backupDriveTimeoutMs: [1_000, 900_000],
  backupIntervalMs: [60_000, 900_000],
