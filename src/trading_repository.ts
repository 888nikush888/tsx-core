...
function validateAccountStateUpdate(state: TradingAccountStateUpdate): void {
  ...
  // Match any ASCII control character including delete via Unicode property escape
  if (externalAccountId && (externalAccountId.length > 256 || /[\p{Cc}\x7f]/u.test(externalAccountId))) {
