...
assert.match(prometheusModuleLock, /google\.golang\.org\/grpc v1\.83\.2/);
assert.match(prometheusSumLock, /google\.golang\.org\/grpc v1\.83\.2 h1:/);
assert.match(prometheusDockerfile, /test "\$\(go list -m -f '\{\{\.Version\}\}' google\.golang\.org\/grpc\)" = "v1\.83\.2"/);
