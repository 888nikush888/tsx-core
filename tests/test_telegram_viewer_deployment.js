...
assert.match(compose, /^  core-network:\s*$/m);
assert.match(compose, /^  viewer-network:\s*$/m);
...
assert.match(compose, /^  telegram_viewer_secrets:\s*$/m);
assert.match(compose, /^  telegram_viewer_state:\s*$/m);
