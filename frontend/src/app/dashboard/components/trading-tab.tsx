...
const DEFAULT_CONFIGURATION = {
  ...
  exits: { targetAllocationsPercent: ["50", "50"], moveStopToBreakEvenAfterTarget: 1, trailingStopPercent: null, closeRemainderAtLastTarget: true },
